...
## Project Structure
    ...
    ├── testapiautoteammemb_92714  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_92714`
...
2. Clone this repo and `cd testapiautoteammemb_92714`
